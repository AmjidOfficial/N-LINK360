    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="p-3 bg-secondary/10 rounded-lg text-amber-600">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b pb-3">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-text-primary">1. Credit Check Engine (Green / Amber / Red)</h2>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1.5 border rounded-md font-mono bg-bg-secondary text-text-primary font-semibold"
              />
            </div>
            <div>
          ...
          <div className={`p-4 rounded-lg border ${
            ...
            <div className="flex items-start gap-2.5">
              {creditResult.status === 'GREEN' ? (
                <CheckCircle2 className="w-5 h-5 text-deep-teal shrink-0 mt-0.5" />
              ) : creditResult.status === 'AMBER' ? (
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b pb-3">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-text-primary">2. Inventory Transaction Engine</h2>
            </div>
          ...
          <div className="grid grid-cols-3 gap-3 text-xs">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-2 py-1.5 border rounded-md text-xs font-mono bg-bg-secondary text-text-primary"
              >
          ...
          <div className={`p-4 rounded-lg border ${
            stockError
              ...
              : 'bg-primary text-deep-green hover:bg-primary/90 border-slate-800'
          }`}>
            {stockError ? (
              ...
              <div className="flex items-center justify-between text-xs">
                <div>
                  ...
                  <span className="text-lg font-mono font-bold text-deep-teal">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b pb-3">
            <div className="flex items-center gap-2">
              <Wallet className="w-5 h-5 text-deep-teal" />
              <h2 className="font-bold text-text-primary">3. Customer Ledger Formula</h2>
            </div>
            <span className="text-xs font-mono bg-slate-100 px-2 py-0.5 rounded text-slate-600">
          ...
          <div className="grid grid-cols-3 gap-3 text-xs">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1.5 border rounded-md font-mono bg-bg-secondary text-emerald-700 font-semibold"
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1.5 border rounded-md font-mono bg-bg-secondary text-sky-700 font-semibold"
              />
            </div>
          </div>

          <div className="p-4 bg-primary text-deep-green hover:bg-primary/90 rounded-lg border border-slate-800 flex items-center justify-between">
            <div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b pb-3">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-text-primary">4. Recovery Collection Validation</h2>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-1.5 border rounded-md text-xs bg-bg-secondary text-text-primary"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1.5 border rounded-md font-mono bg-bg-secondary text-text-primary"
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1.5 border rounded-md bg-bg-secondary text-text-primary"
              />
            </div>
          </div>
