    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 text-white rounded-2xl p-6 relative overflow-hidden shadow-md">
        ...
        <div className="relative z-10 space-y-2">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <span className="bg-amber-400 text-slate-950 px-2.5 py-0.5 rounded text-[10px] font-black uppercase tracking-wider">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-amber-400 hover:bg-amber-300 text-slate-950 font-extrabold text-xs rounded-xl shadow-md transition-all self-stretch sm:self-auto text-center justify-center"
            >
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-4">
        <div className="flex items-center gap-2 border-b pb-3">
          ...
          <div>
            <h3 className="font-bold text-slate-900 text-sm">Centralized Packaging Conversion Simulator</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
          ...
          <div className="md:col-span-4 bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-4">
            ...
            <div className="flex border rounded-lg overflow-hidden text-xs">
              <button
                ...
                className={`flex-1 py-2 text-center font-bold ${simulationMode === 'UNITS_TO_PKG' ? 'bg-slate-900 text-white' : 'bg-white hover:bg-slate-100 text-slate-600'}`}
              >
                Units → Packaging
              </button>
              <button
                onClick={() => setSimulationMode('PKG_TO_UNITS')}
                className={`flex-1 py-2 text-center font-bold ${simulationMode === 'PKG_TO_UNITS' ? 'bg-slate-900 text-white' : 'bg-white hover:bg-slate-100 text-slate-600'}`}
              >
                Packaging → Units
              </button>
            </div>
          ...
          <div className="md:col-span-8 p-5 rounded-xl border border-dashed border-slate-300 bg-slate-50/40 flex flex-col justify-between min-h-[180px]">
            {simulationMode === 'UNITS_TO_PKG' ? (
              <div className="space-y-4">
                <div className="space-y-1">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="w-48 px-3 py-2 border rounded-lg font-mono text-sm font-bold bg-white focus:outline-none focus:border-amber-500"
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="p-3 bg-slate-900 text-white rounded-lg text-center shadow-sm">
                    <span className="text-[10px] text-slate-400 block uppercase font-bold">Cartons / Bags</span>
                    <span className="text-xl font-bold font-mono text-amber-400">{simBreakdown.cartons}</span>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-slate-900 text-white rounded-lg flex justify-between items-center shadow-sm">
                  <div>
                    <span className="text-xs text-slate-400 block">Calculated Net Raw Quantity:</span>
                    <span className="text-lg font-mono font-bold text-emerald-400">{calculatedSimUnits} Pcs</span>
                  </div>
          ...
          <div className="flex flex-wrap items-center gap-2 flex-1">
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 text-xs bg-slate-50 border rounded-lg focus:outline-none focus:ring-1 focus:ring-amber-500"
              />
            </div>
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100 font-mono">
              {filteredSKUs.map((sku) => {
                ...
                return (
                  <tr key={sku.id} className="hover:bg-slate-50/75 font-sans">
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-lg w-full overflow-hidden border border-slate-100 animate-in fade-in zoom-in-95 duration-150">
            ...
            <form onSubmit={handleAddSkuSubmit} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-3 text-xs">
                ...
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 border rounded-lg focus:outline-none focus:border-amber-500 font-medium"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 border rounded-lg focus:outline-none focus:border-amber-500 font-mono font-bold"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-1.5 border rounded-lg focus:outline-none focus:border-amber-500 font-medium"
                  >
              ...
              <div className="pt-4 flex gap-2 border-t text-xs">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2 bg-slate-900 hover:bg-slate-800 text-amber-400 font-extrabold rounded-lg transition-colors shadow-md"
                >
                  Save to Registry
                </button>
              </div>
