  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 p-4 backdrop-blur-xs">
      <div className="flex h-full max-h-[90vh] w-full max-w-5xl flex-col rounded-2xl bg-white shadow-2xl overflow-hidden border border-slate-200">
        ...
        {/* Diff Drawer / Modal */}
        {selectedLogForDiff && (
          <div className="fixed inset-0 z-60 flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-2xs">
            <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-2xl border border-slate-200 space-y-4">
              <div className="flex items-center justify-between border-b pb-3">
                <div>
                  <h4 className="text-sm font-bold text-slate-900">Audit State Mutation Inspector</h4>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="space-y-1">
                  ...
                  <pre className="p-3 bg-slate-900 text-slate-100 rounded-b font-mono text-[10px] overflow-x-auto max-h-56">
