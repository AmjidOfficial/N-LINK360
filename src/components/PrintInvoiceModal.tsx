          ...
          {(printMode === 'A4_FORMAL' || printMode === 'A5_COMPACT' || printMode === 'LETTER_STANDARD') && (
            <div className={`invoice-print-container mx-auto w-full bg-white p-6 sm:p-10 shadow-lg border border-slate-200 text-text-primary font-sans print-area print:shadow-none print:border-none print:p-0 ${
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b-2 border-slate-900 pb-4 gap-4">
                <div className="flex items-center gap-3">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-secondary/80 font-black text-2xl text-deep-green border border-slate-900 shadow-sm">
                    NL
                  </div>
                  <div>
                    ...
                    {invoice.items.map((item, idx) => {
                      ...
                      return (
                        <tr key={idx} className="hover:bg-bg-secondary/50">
                          ...
                          <td className="py-2.5 px-2 text-right font-mono font-bold text-deep-green">
                            {net.toFixed(2)}
                          </td>
                        </tr>
                      );
              ...
              <div className="grid grid-cols-12 gap-4 border-t-2 border-slate-900 pt-4">
                ...
                <div className="col-span-7 space-y-3">
                  <div className="rounded-lg bg-bg-secondary p-3 border border-slate-200/70">
                ...
                <div className="col-span-5 space-y-1.5 text-xs">
                  ...
                  <div className="flex justify-between py-2 border-b-2 border-slate-900 text-sm font-black text-deep-green bg-amber-50 px-2 rounded">
