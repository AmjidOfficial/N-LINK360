          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2">
                <span className="px-2.5 py-0.5 rounded text-xs font-mono font-semibold bg-amber-500/20 text-amber-300 border border-amber-500/30">
                  PHASE 0 FOUNDATION
                </span>
                <a
        ...
        <div className="p-6 text-slate-800 leading-relaxed font-sans text-sm overflow-x-auto">
          {activeDoc === 'BLUEPRINT' && (
            <div className="space-y-6 max-w-4xl">
              ...
              <div>
                <h2 className="text-lg font-bold text-slate-900 border-b pb-2 mb-3">
              ...
              <div>
                ...
                <div className="space-y-3 font-mono text-xs">
                  <div className="p-3 bg-slate-900 text-emerald-400 rounded-lg">
            ...
            <div className="space-y-6 max-w-5xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50 border rounded-lg">
                  <h3 className="font-bold text-slate-900 text-sm mb-2 text-amber-700">1. Organization</h3>
                  <ul className="text-xs space-y-1 text-slate-700 font-mono">
                    <li><strong className="text-slate-900">companies:</strong> Company code, tax number, currency</li>
                    <li><strong className="text-slate-900">branches:</strong> Multi-city branch network</li>
                    <li><strong className="text-slate-900">factories:</strong> Production plants (Sundar Estate, etc.)</li>
                    <li><strong className="text-slate-900">warehouses:</strong> Central, Regional, Transit, Damage</li>
                  </ul>
                </div>

                <div className="p-4 bg-slate-50 border rounded-lg">
                  <h3 className="font-bold text-slate-900 text-sm mb-2 text-amber-700">2. Security & RBAC</h3>
                  <ul className="text-xs space-y-1 text-slate-700 font-mono">
                    <li><strong className="text-slate-900">roles:</strong> 8 distinct system roles</li>
                    <li><strong className="text-slate-900">permissions:</strong> Granular feature permissions</li>
                    <li><strong className="text-slate-900">users:</strong> User identity and branch linkage</li>
                    <li><strong className="text-slate-900">audit_logs:</strong> Immutable state change logs (JSONB)</li>
                  </ul>
                </div>

                <div className="p-4 bg-slate-50 border rounded-lg">
                  <h3 className="font-bold text-slate-900 text-sm mb-2 text-amber-700">3. Products & SKUs</h3>
                  <ul className="text-xs space-y-1 text-slate-700 font-mono">
                    <li><strong className="text-slate-900">product_categories:</strong> Bulbs, Panels, Floods</li>
                    <li><strong className="text-slate-900">brands:</strong> National Pro, National EcoLine</li>
                    <li><strong className="text-slate-900">products:</strong> Base item definitions</li>
                    <li><strong className="text-slate-900">skus:</strong> Wattage, CCT, Trade/Retail/Min Price</li>
                  </ul>
                </div>

                <div className="p-4 bg-slate-50 border rounded-lg">
                  <h3 className="font-bold text-slate-900 text-sm mb-2 text-amber-700">4. Sales Field & Customers</h3>
                  <ul className="text-xs space-y-1 text-slate-700 font-mono">
                    <li><strong className="text-slate-900">customers:</strong> Distributors & Dealers with Credit Limits</li>
                    <li><strong className="text-slate-900">sales_users:</strong> Employee code, region, monthly targets</li>
                    <li><strong className="text-slate-900">customer_assignments:</strong> Account mapping</li>
                    <li><strong className="text-slate-900">customer_visits:</strong> GPS check-in/out records</li>
                  </ul>
                </div>

                <div className="p-4 bg-slate-50 border rounded-lg">
                  <h3 className="font-bold text-slate-900 text-sm mb-2 text-amber-700">5. Inventory & Production</h3>
                  <ul className="text-xs space-y-1 text-slate-700 font-mono">
                    <li><strong className="text-slate-900">production_batches:</strong> Factory batches & QC notes</li>
                    <li><strong className="text-slate-900">production_items:</strong> Planned vs produced quantities</li>
                    <li><strong className="text-slate-900">inventory_transactions:</strong> Immutable source of truth</li>
                    <li><strong className="text-slate-900">inventory_balances:</strong> Fast projection cache</li>
                  </ul>
                </div>

                <div className="p-4 bg-slate-50 border rounded-lg">
                  <h3 className="font-bold text-slate-900 text-sm mb-2 text-amber-700">6. Orders & Invoicing</h3>
                  <ul className="text-xs space-y-1 text-slate-700 font-mono">
                    <li><strong className="text-slate-900">sales_orders:</strong> Order items, credit check evaluation</li>
                    <li><strong className="text-slate-900">invoices:</strong> Atomic stock-out + ledger debit</li>
                    <li><strong className="text-slate-900">invoice_items:</strong> Invoiced lines & discounts</li>
                  </ul>
                </div>

                <div className="p-4 bg-slate-50 border rounded-lg">
                  <h3 className="font-bold text-slate-900 text-sm mb-2 text-amber-700">7. Logistics & Dispatch</h3>
                  <ul className="text-xs space-y-1 text-slate-700 font-mono">
                    <li><strong className="text-slate-900">dispatches:</strong> Transporter, vehicle, driver, bility</li>
                    <li><strong className="text-slate-900">goods_receipts:</strong> GRN receiving and short/excess</li>
                  </ul>
                </div>

                <div className="p-4 bg-slate-50 border rounded-lg">
                  <h3 className="font-bold text-slate-900 text-sm mb-2 text-amber-700">8. Accounts & Recovery</h3>
                  <ul className="text-xs space-y-1 text-slate-700 font-mono">
                    <li><strong className="text-slate-900">recoveries:</strong> Cash, cheque, bank transfer logs</li>
                    <li><strong className="text-slate-900">ledger_entries:</strong> Debits, credits, running balance</li>
                    <li><strong className="text-slate-900">credit_notes / debit_notes:</strong> Reversals & allowances</li>
                  </ul>
                </div>
              </div>
            </div>
...
+-----------------------------------------------------------------------------------+`}
          ...
          {activeDoc === 'ENV' && (
            <div className="space-y-4 max-w-3xl">
              ...
              <div className="p-4 bg-slate-50 border rounded-lg text-xs space-y-2">
                <p><strong className="text-slate-900">DEV Environment:</strong> Project <code className="bg-slate-200 px-1 rounded">n-link360-dev</code> using synthetic fixture data exclusively.</p>
                <p><strong className="text-slate-900">PROD Environment:</strong> Dedicated isolated project <code className="bg-slate-200 px-1 rounded">n-link360-prod</code> upon pilot approval.</p>
                <p><strong className="text-slate-900">Free-First Policy:</strong> Zero paid upgrades or subscriptions permitted during development. Operates entirely within Supabase free-tier PostgreSQL, free auth, free storage, and AI Studio free models.</p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4 max-w-4xl">
              ...
              <div className="space-y-2 text-xs">
                <div className="p-3 bg-emerald-50 border border-emerald-300 rounded-lg flex items-center justify-between">
                  ...
                  <span className="px-2.5 py-1 bg-emerald-600 text-white rounded font-semibold text-[11px]">COMPLETED</span>
                </div>

                <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between">
                  <div>
                    <strong className="text-slate-900 font-bold">Phase 1: Identity & Masters Management</strong>
                ...
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between opacity-80">
                  <div>
                    <strong className="text-slate-900 font-bold">Phase 2: Inventory & Production Engine</strong>
                ...
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between opacity-80">
                  <div>
                    <strong className="text-slate-900 font-bold">Phase 3: Sales & Recovery Field Mobile App</strong>
                ...
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between opacity-80">
                  <div>
                    <strong className="text-slate-900 font-bold">Phase 4: Order to Invoice & Atomic Ledger Integration</strong>
                ...
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between opacity-80">
                  <div>
                    <strong className="text-slate-900 font-bold">Phase 5: Logistics, Dispatch & GRN</strong>
                ...
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between opacity-80">
                  <div>
                    <strong className="text-slate-900 font-bold">Phase 6: Accounts, Recovery Verification & Statements</strong>
                ...
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between opacity-80">
                  <div>
                    <strong className="text-slate-900 font-bold">Phase 7: Reverse Logistics & Damaged Stock</strong>
                ...
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between opacity-80">
                  <div>
                    <strong className="text-slate-900 font-bold">Phase 8: Executive Intelligence & Performance Analytics</strong>
                ...
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between opacity-80">
                  <div>
                    <strong className="text-slate-900 font-bold">Phase 9 & 10: In-App Alerts, Security Audit & Pilot Rollout</strong>
          ...
          {activeDoc === 'MIGRATION_SQL' && (
            <div>
              ...
              <pre className="p-4 bg-slate-950 text-slate-200 rounded-lg text-xs font-mono overflow-x-auto max-h-[500px]">
          ...
          {activeDoc === 'SEED_SQL' && (
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-emerald-600 font-semibold">DEV Synthetic Dataset</span>
              </div>
              <pre className="p-4 bg-slate-950 text-slate-200 rounded-lg text-xs font-mono overflow-x-auto max-h-[500px]">
