      ...
      <div className="flex-1 p-4 overflow-y-auto space-y-4 text-xs bg-slate-900">
        ...
        {activeScreen === 'DASHBOARD' && (
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-r from-amber-500/10 to-amber-500/5 border border-amber-500/20 rounded-2xl p-3.5 flex items-center justify-between">
              <div className="space-y-0.5">
                <span className="font-bold text-amber-400 block text-[11px] uppercase tracking-wide">Register Client Lead</span>
              ...
              <div className="flex gap-1.5">
                <button
                  ...
                  className="px-3 py-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded-xl text-[10px] whitespace-nowrap"
                >
                  + New Lead
                </button>
                <button
            ...
            <div className="space-y-2 pt-2">
              ...
              {visits.map((v) => (
                <div key={v.id} className="p-3 bg-slate-950/80 rounded-xl border border-slate-800 space-y-1">
                  ...
                  {v.photoUrl && (
                    <div className="my-2 rounded-lg overflow-hidden border border-slate-800/85 max-h-36 bg-slate-900 flex items-center justify-center">
        ...
        {activeScreen === 'ORDER_BOOKING' && (
          <div className="space-y-4 relative pb-20">
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-2">
              ...
              <span className="px-2 py-0.5 bg-amber-500/10 text-amber-400 font-mono text-[10px] rounded">
                Active Booking
              </span>
            </div>
            ...
            <div className="bg-slate-950 p-3.5 rounded-2xl border border-slate-800 space-y-3">
              <div className="flex items-center justify-between">
                ...
                {selectedCustomerId && (
                  <button
                    ...
                    className="text-amber-400 text-[10px] hover:underline font-bold"
                  >
                    Change Client
                  </button>
                )}
              ...
              {!selectedCustomerId || isCustomerDropdownOpen ? (
                <div className="space-y-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 bg-slate-900 border border-slate-700 rounded-xl text-white font-semibold text-xs focus:ring-1 focus:ring-amber-500"
                    />
                  </div>

                  {/* Filtered Dropdown List */}
                  <div className="max-h-48 overflow-y-auto bg-slate-900 border border-slate-800 rounded-xl divide-y divide-slate-800">
                    {customers
                      .filter((c) => {
                      ...
                      .map((c) => (
                        ...
                        >
                          <div>
                            <div className="flex items-center gap-1.5">
                              <span className="text-[10px] bg-slate-800 font-mono font-bold text-amber-400 px-1 py-0.5 rounded">
                                {c.customerCode}
                              </span>
                          ...
                          <div className="text-right text-[10px] text-slate-400">
                            Outstanding: <span className="font-mono text-amber-400 font-bold block">PKR {c.currentBalance.toLocaleString()}</span>
                          </div>
                        </div>
                      ))}
                  </div>
                ...
                <div className="p-2.5 bg-slate-900 rounded-xl border border-slate-850 flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] bg-amber-500/10 font-mono font-bold text-amber-400 px-1.5 py-0.5 rounded">
            ...
            <div className="bg-slate-950 p-3 rounded-2xl border border-slate-800 space-y-1.5">
              ...
              <div className="grid grid-cols-3 bg-slate-900 rounded-xl overflow-hidden border border-slate-800 divide-x divide-slate-800 text-center">
                <div className="p-2.5">
                ...
                <div className="p-2.5 bg-emerald-950/20">
                  <span className="text-[9px] text-emerald-400 block">Recovery Entry</span>
                ...
                <div className="p-2.5">
                  ...
                  <span className="text-[11px] font-bold text-amber-400 font-mono block mt-0.5">
            ...
            <div className="bg-slate-950 p-3.5 rounded-2xl border border-slate-800 space-y-3">
              <div className="flex items-center justify-between">
                ...
                {/* Backorder Toggle */}
                <label className="flex items-center gap-1.5 cursor-pointer text-[10px] select-none bg-slate-900 px-2 py-1 rounded-lg border border-slate-800">
                  <input
                    type="checkbox"
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-3 py-1.5 bg-slate-900 border border-slate-800 rounded-xl text-white text-[11px]"
                />
              </div>

              {/* Dynamic SKU Grid Table */}
                ...
                <table className="w-full text-left text-[11px]">
                  <thead className="bg-slate-950 text-slate-400 text-[10px] uppercase font-mono border-b border-slate-800">
                    <tr>
                      ...
                      <th className="p-2 text-right w-16">Avail</th>
                      <th className="p-2 text-center w-20">Order Qty</th>
                    </tr>
                  </thead>
                      ...
                      .map((sku, idx) => {
                        ...
                        return (
                          <tr key={sku.id} className="hover:bg-slate-800/40">
                            <td className="p-2 text-center text-slate-500 font-mono font-semibold">{idx + 1}</td>
                            <td className="p-2">
                              ...
                              <div className="flex gap-2 items-center text-[9px] text-slate-500 mt-0.5">
                                <span className="font-mono bg-slate-800 text-slate-300 px-1 rounded">{sku.skuCode}</span>
                                <span>PKR {sku.tradePrice}</span>
                              </div>
                            </td>
                            <td className="p-2 text-right font-mono font-bold text-slate-300">
                              <span className={availableQty === 0 ? 'text-rose-400' : 'text-slate-300'}>
                                {availableQty}
                              </span>
                            </td>
                            <td className="p-2 text-center">
                              <input
                                ...
                                className="w-16 p-1 bg-slate-950 border border-slate-700 rounded text-center text-white font-bold font-mono focus:border-amber-500"
                              />
                            </td>
                          </tr>
                        );
              ...
              {gridComputedItems.length > 0 && (
                <div className="p-2.5 bg-slate-900 rounded-xl border border-slate-800/60 flex items-center justify-between text-[11px] font-mono">
                  <div>
            ...
            <div className="bg-slate-950 p-3.5 rounded-2xl border border-slate-800 space-y-3">
              ...
              <div className="space-y-2.5">
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-2 bg-slate-900 border border-slate-700 rounded-xl font-mono text-emerald-400 font-bold"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full p-2 bg-slate-900 border border-slate-700 rounded-xl text-white font-semibold text-xs"
                    >
                ...
                {orderRecoveryAmount > 0 && (
                  <div className="space-y-2 p-3 bg-slate-900 rounded-xl border border-slate-800 animate-fadeIn">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full p-1.5 bg-slate-950 border border-slate-700 rounded-lg text-white font-mono text-[11px]"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            ...
                            className="w-full p-1.5 bg-slate-950 border border-slate-700 rounded-lg text-white text-[11px]"
                          />
                        </div>
                      </div>
                    )}
              ...
              <button
                ...
                className={`w-full py-3.5 rounded-2xl font-bold text-sm shadow-md transition-all flex items-center justify-center gap-2 ${
                  gridComputedItems.length === 0
                    ...
                    : 'bg-amber-500 hover:bg-amber-400 text-slate-950 hover:shadow-lg hover:shadow-amber-500/10 active:scale-98'
                }`}
              >
            ...
            {showOrderConfirmModal && (
              <div className="absolute inset-0 bg-slate-950/95 z-50 rounded-2xl flex flex-col justify-end p-4 animate-slideUp">
                <div className="bg-slate-900 border border-slate-800 rounded-3xl p-4 space-y-4 max-h-[90%] overflow-y-auto">
                  ...
                  <div className="space-y-3 text-xs">
                    <div className="p-3 bg-slate-950 rounded-xl space-y-2 border border-slate-800">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-amber-400 font-bold">{selectedCustomer.customerCode}</span>
                      </div>
                    </div>

                    <div className="p-3 bg-slate-950 rounded-xl space-y-2 border border-slate-800 font-mono">
                      <div className="flex justify-between">
                    ...
                    <div className="p-3 bg-slate-950 rounded-xl space-y-2 border border-slate-800 font-mono">
                      ...
                      <div className="flex justify-between border-t border-slate-800 pt-1 text-amber-400 font-black">
                  ...
                  <div className="grid grid-cols-2 gap-2.5 pt-2">
                    ...
                    <button
                      ...
                      className="py-3 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black rounded-2xl text-xs active:scale-95 transition-all"
                    >
                      Confirm & Submit
                    </button>
                  </div>
          ...
          return (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative w-full h-[220px] bg-slate-950 rounded-2xl overflow-hidden border border-slate-800 shadow-inner flex flex-col">
                  {/* Map Canvas */}
                  ...
                  <div className="absolute bottom-2 right-2 bg-slate-900/95 border border-slate-800 px-2 py-1 rounded text-[8px] font-mono text-slate-400 flex items-center gap-2">
                    <div className="flex items-center gap-1">
                      <span className="w-1.5 h-1.5 bg-emerald-500 rounded-full"></span> Self
                    </div>
                    <div className="flex items-center gap-1">
                      <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span> Dealers
                    </div>
                    <div className="flex items-center gap-1">
                      <span className="w-1.5 h-1.5 bg-amber-500 rounded-full"></span> Selected
                    </div>
                  </div>
                </div>

                {selectedMapPin ? (
                  <div className="bg-slate-950 p-3 rounded-xl border border-amber-500/30 flex items-center justify-between animate-fade-in">
                    <div className="space-y-0.5">
                      <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] text-slate-400 block font-mono">
                        Distance from check-in: <strong className="text-amber-400">{selectedMapPin.dist} km</strong> 
              ...
              <div className="space-y-2 p-3 bg-slate-950 rounded-xl border border-slate-800">
                ...
                {visitPhoto ? (
                  <div className="space-y-2">
                    <div className="relative rounded-lg overflow-hidden border border-slate-800 bg-slate-900 max-h-48 flex items-center justify-center">
                      ...
                      <div className="absolute bottom-2 left-2 bg-emerald-500/95 text-slate-950 text-[9px] font-bold px-2 py-0.5 rounded shadow">
                        ✓ Snapshot Attached
                      </div>
                    </div>
                    <button
                  ...
                  <div className="space-y-2">
                    <div className="relative rounded-lg overflow-hidden border border-slate-800 bg-slate-900 aspect-video flex flex-col justify-between">
                      <video 
                        ref={videoRef} 
                        autoPlay 
                        playsInline 
                      ...
                      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-2">
                        <button
                          ...
                          className="px-4 py-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded-lg text-xs shadow-lg"
                        >
                          Capture
                        </button>
                        <button
                  ...
                  <div className="space-y-2">
                    <div className="flex gap-2">
                      <button
                        onClick={startCamera}
                        className="flex-1 py-3 bg-slate-900 hover:bg-slate-850 text-amber-400 rounded-lg font-bold border border-slate-750 flex flex-col items-center justify-center gap-1 shadow transition-all active:scale-95"
                      >
                        <Camera className="w-5 h-5 text-amber-400" />
                        <span className="text-[10px]">Take Live Photo</span>
                      </button>

                      <label className="flex-1 py-3 bg-slate-900 hover:bg-slate-850 text-slate-300 rounded-lg font-bold border border-slate-750 flex flex-col items-center justify-center gap-1 shadow transition-all active:scale-95 cursor-pointer">
                        <input 
                          type="file" 
                          accept="image/*" 
                    ...
                    <div className="pt-1 border-t border-slate-900">
                      ...
                      <div className="flex gap-1.5">
                        <button 
                          ...
                          className="flex-1 py-1 bg-slate-900 hover:bg-slate-850 text-slate-400 rounded border border-slate-800 text-[9px] font-semibold"
                        >
                          + Storefront
                        </button>
                        <button 
        ...
        {activeScreen === 'REGISTRATION_FORM' && (
          <div className="space-y-4">
            <div className="border-b border-slate-800 pb-2 flex items-center justify-between">
              ...
              <span className="px-2 py-0.5 bg-amber-500/10 text-amber-400 border border-amber-500/20 rounded font-mono text-[9px] uppercase font-bold">
            ...
            <div className="space-y-3">
              {/* Business Details */}
              <div className="space-y-2 p-3 bg-slate-950 rounded-xl border border-slate-800">
                <span className="text-amber-400 text-[9px] uppercase font-bold tracking-wider block">Business Identification</span>
              ...
              <div className="space-y-2 p-3 bg-slate-950 rounded-xl border border-slate-800">
                <span className="text-amber-400 text-[9px] uppercase font-bold tracking-wider block">Owner & Verification Info</span>
              ...
              {/* Physical Location */}
              <div className="space-y-2 p-3 bg-slate-950 rounded-xl border border-slate-800">
                <span className="text-amber-400 text-[9px] uppercase font-bold tracking-wider block">Shop Location & Address</span>
                ...
                <div className="p-2.5 bg-slate-900 rounded border border-slate-800 flex items-center justify-between text-[10px]">
              ...
              <div className="space-y-2 p-3 bg-slate-950 rounded-xl border border-slate-800">
                <span className="text-amber-400 text-[9px] uppercase font-bold tracking-wider block">Proposed Accounts terms</span>
              ...
              <button
                ...
                className="w-full py-3 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded-xl shadow-md text-sm transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="space-y-4">
              ...
              {myRequests.length === 0 ? (
                <div className="text-center py-10 bg-slate-950 rounded-2xl border border-slate-800 space-y-2">
                  ...
                  <button 
                    onClick={() => setActiveScreen('REGISTRATION_FORM')}
                    className="px-3 py-1 bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 border border-amber-500/30 rounded text-[10px] font-bold"
                  >
                ...
                <div className="space-y-2.5">
                  {myRequests.map((req) => (
                    ...
                    >
                      ...
                      {req.status === 'APPROVED' && (
                        <div className="p-2.5 bg-emerald-500/10 border border-emerald-500/20 rounded-xl space-y-1 text-[10px] text-emerald-300">
