    ...
    cities: [
      {
        ...
        name: 'Peshawar',
        regionId: 'KPK',
        commercialHub: 'Sheikh Yaseen Tower / Karkhano / Saddar',
        majorBeats: [
          'Duran Pur Route / GT Road Beat',
          'City Circular Road Beat',
          'University Road Beat',
          'Karkhano Market Beat',
          'Majid Mohabbad Khan Road',
          'Hayatabad Trade Zone',
          'Kohat Road Beat',
          'Saddar Cantonment Beat',
        ],
      },
...
/**
 * Authoritative Master List of All Commercial Towns across Pakistan
 * Note: 'Duran Pur' is a designated trade route/beat of Peshawar, not an independent town.
 */
export const ALL_PAKISTAN_TOWNS: string[] = [
  'Peshawar',
  'Abbottabad',
  'Mardan',
  'Swat (Mingora)',
...
/**
 * Route and Beat associations for key trade cities
 */
export const CITY_ROUTES_AND_BEATS: Record<string, string[]> = {
  Peshawar: [
    'Duran Pur Route / GT Road Beat',
    'City Circular Road Beat',
    'University Road Beat',
    'Karkhano Market Beat',
    'Hayatabad Industrial Trade Zone Beat',
    'Kohat Road Beat',
    'Saddar Cantonment Beat',
    'Sheikh Yaseen Tower Lighting Hub',
  ],
  Abbottabad: [
    'Supply Bazar Beat',
    'Mansehra Road Beat',
    'Cantonment Commercial Beat',
    'Jinnah Road Market Beat',
  ],
  Mardan: [
    'Bank Road Beat',
    'Shahbaz Garhi Beat',
    'Gujar Garhi Market Beat',
  ],
  'Swat (Mingora)': [
    'Main Mingora Bazar Beat',
    'New Road Beat',
    'Matta Commercial Beat',
  ],
  Rawalpindi: [
    'College Road Electronics Beat',
    'Raja Bazar Beat',
    'Saddar Commercial Beat',
    'Murree Road Electricals Beat',
  ],
  Islamabad: [
    'Blue Area Electrical Corridor Beat',
    'G-9 Karachi Company Beat',
    'I-9 / I-10 Industrial Area Beat',
    'PWD / Pakistan Town Beat',
  ],
  Lahore: [
    'Hall Road Electronics Beat',
    'Shah Alam Market Beat',
    'Brandreth Road Electricals Beat',
    'DHA Phase 5 & 6 Commercial Beat',
  ],
};
